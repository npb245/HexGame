describe("In Hex Game", function() {
  ...
  it("B can get a DIAGONAL win;corner cell belongs to two edges", function() {
	  var board=_gameLogic.getInitialBoard();
	board=  [['B', 'R', '', '', '', '', '', '', '', '', ''], ['', 'B', 'R', '', '', '', '', '', '', '', ''], ['', '', 'B', 'R', '', '', '', '', '', '', ''],
	 	    ['', '', '', 'B', 'R', '', '', '', '', '', ''], ['', '', '', '', 'B', 'R', '', '', '', '', ''], ['', '', '', '', '', 'B', 'R', '', '', '', ''],
		    ['', '', '', '', '', '', 'B', 'R', '', '', ''], ['', '', '', '', '', '', '', 'B', 'R', '', ''], ['', '', '', '', '', '', '', '', 'B', 'R', ''], 
  ...
  it("R can get a DIAGONAL win;corner cell belongs to two edges", function() {
	  var board=_gameLogic.getInitialBoard();
	board=  [['R', 'B', '', '', '', '', '', '', '', '', ''], ['', 'R', 'B', '', '', '', '', '', '', '', ''], ['', '', 'R', 'B', '', '', '', '', '', '', ''],
	 	    ['', '', '', 'R', 'B', '', '', '', '', '', ''], ['', '', '', '', 'R', 'B', '', '', '', '', ''], ['', '', '', '', '', 'R', 'B', '', '', '', ''],
		    ['', '', '', '', '', '', 'R', 'B', '', '', ''], ['', '', '', '', '', '', '', 'R', 'B', '', ''], ['', '', '', '', '', '', '', '', 'R', 'B', ''], 
  ...
  it("B can get a vertical win: game rules dont mention that B can only win horizontally", function() {
	  var board=_gameLogic.getInitialBoard();
	board= [['', 'B', '', 'R', '', '', '', '', '', '', ''], ['', 'B', '', 'R', '', '', '', '', '', '', ''], ['', 'B', '', 'R', '', '', '', '', '', '', ''],
	        ['', 'B', '', 'R', '', '', '', '', '', '', ''], ['', 'B', '', 'R', '', '', '', '', '', '', ''], ['', 'B', '', 'R', '', '', '', '', '', '', ''],
	        ['', 'B', '', 'R', '', '', '', '', '', '', ''], ['', 'B', '', 'R', '', '', '', '', '', '', ''], ['', '', '', '', '', '', '', '', '', '', ''], 
  ...
  it("R can get a Horizontal win: game rules dont mention that R can only win vertically", function() {
	  var board=_gameLogic.getInitialBoard();
